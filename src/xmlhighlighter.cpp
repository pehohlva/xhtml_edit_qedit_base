...
void XmlHighlighter::setHighlightColor(HighlightType type, QColor color,
                                       bool foreground) {
...
void XmlHighlighter::setHighlightFormat(HighlightType type,
                                        QTextCharFormat format) {
  switch (type) {
  case SyntaxChar:
...
void XmlHighlighter::highlightBlock(const QString &text) {
  ...
  state = (previousBlockState() == InElement ? ExpectAttributeOrEndOfElement
                                             : NoState);
