...
void  Base_Edit::CreateanewTable()
{
    ...
    int righe = QInputDialog::getInt(this, tr("New Table row"),tr("Row:"), 3, 1, 100, 1, &ok);
    int largo = QInputDialog::getInt(this, tr("New Table percent on page"),tr("Percent \%:"), 100, 10, 100, 1, &ok);
...
void  Base_Edit::AppendTableRows()
{
    ...
    int cellcoolcursoris = existingcell.column(); /* int value start from zero */
    int cellrowcursoris = existingcell.row(); /* int value start from zero */
    int approwtot = QInputDialog::getInt(this, tr("Append NR. line row"),tr("Row:"), 1, 1, 100, 1, &ok);
...
void  Base_Edit::AppendTableCools()
{
    ...
    if (Etable) {
        ...
        int cellcoolcursoris = existingcell.column(); /* int value start from zero */
        int cellrowcursoris = existingcell.row(); /* int value start from zero */
        int appcooltot = QInputDialog::getInt(this, tr("Tabella appendi colonne"),tr("Cool:"), 1, 1, 10, 1, &ok);
